...
User.add({
	...
	isFilanthropyMember: {type: Boolean, default: false, note: 'Controls whether a user appears on the about page'},
	isCurrentFilanthropyMember: {type: Boolean, default: false, note: 'Used in conjunction with the above, this controls whether the user has a full profile or whether they appear in the Thank You section on the about page'},
...
//},
 'Permissions', {
	isAdmin: { type: Boolean, label: 'Can Admin Filanthropy*' },
...
User.schema.methods.resetPassword = function(callback) {
	...
	user.save(function(err) {
		...
		new keystone.Email('forgotten-password').send({
			...
			subject: 'Reset your Filanthropy* Password',
			to: user.email,
			from: {
				name: 'Filanthropy*',
				email: 'filanthropystar@gmail.com'
